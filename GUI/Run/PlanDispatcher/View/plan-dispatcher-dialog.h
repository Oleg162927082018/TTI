...
#include "GUI/Run/PlanDispatcher/Controller/task-table-adapter.h"
#include "GUI/Run/PlanDispatcher/Controller/log-adapter.h"
...
public:
    explicit PlanDispatcherDialog(QWidget *parent = nullptr);
