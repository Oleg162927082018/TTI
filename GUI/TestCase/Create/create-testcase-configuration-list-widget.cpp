...
bool CreateTestCaseConfigurationListWidget::SaveTestCase(QString fullFileName)
{
    ...
    TestCase tc;
    tc.ID = ID;
    tc.CurrentConfigName = ui->currentConfigBox->currentText();
    ...
    QMap<QString, QDomDocument *> *testList = currrentConfigWidget->GetTestList();
    DBManager::SaveTestCaseCache(fullFileName, testList);
    delete testList;
