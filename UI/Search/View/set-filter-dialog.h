...
#include <UI/Search/Controller/set-filter-testcase-list-adapter.h>
#include <UI/Search/Controller/set-filter-tag-tree-adapter.h>
#include <UI/Search/Model/set-filter-dialog-model.h>
#include <UI/Search/Controller/set-filter-status-table-adapter.h>
