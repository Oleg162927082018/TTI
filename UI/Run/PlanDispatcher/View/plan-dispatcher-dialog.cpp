...
#include "UI/Run/PlanDispatcher-Add/View/plan-add-dialog.h"
#include "UI/Run/PlanDispatcher-Edit/View/plan-edit-dialog.h"
#include "UI/Run/PlanDispatcher-New/View/plan-new-dialog.h"
...
PlanDispatcherDialog::PlanDispatcherDialog(QWidget *parent) :
    QDialog(parent),
...
void PlanDispatcherDialog::on_newBtn_clicked()
{
    ...
    PlanNewDialog *dlg = (qobject_cast<MainWindow *>(parent()))->createPlanNewDialog();
...
void PlanDispatcherDialog::on_showLog34Btn_clicked()
{
    ...
    ui->splitter->setSizes(QList<int>{H/4,(H*3)/4});
...
void PlanDispatcherDialog::on_showLog24Btn_clicked()
{
    ...
    int H = ui->splitter->height() - ui->splitter->handleWidth();
    ui->splitter->setSizes(QList<int>{H/2,H/2});
...
void PlanDispatcherDialog::on_showLog14Btn_clicked()
{
    ...
    int H = ui->splitter->height() - ui->splitter->handleWidth();
    ui->splitter->setSizes(QList<int>{(H*3)/4,H/4});
