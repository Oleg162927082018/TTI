...
#include "UI/MainWindow/Model/mainwindow-treefolder.h"
#include "UI/MainWindow/Model/mainwindow-tableitem.h"
#include "UI/Run/PlanDispatcher/View/plan-dispatcher-dialog.h"
#include "UI/TestCase/Create/View/create-testcase-dialog.h"
#include "UI/TestCase/Open/View/open-testcase-dialog.h"
#include "UI/RunHeader/RunHeadersDialog/View/run-headers-dialog.h"
#include "UI/Tag/Dispatcher/View/tag-dispatcher-dialog.h"
#include "UI/Tag/View/View/tag-view-dialog.h"
#include "UI/Search/View/set-filter-dialog.h"
...
{
    if(arg1.fragment().compare("remove") == 0)
    {
        ...
        if(mb.exec() == QMessageBox::Ok)
        {
            ...
            testItem->status->tags.removeAll(arg1.scheme() + "://" + arg1.path());
            DBManager::SaveTestStatus(testItem->ownerTestCase->fullFileName, testItem->status);
            updateTagList(testItem);
        }

    } else if(arg1.fragment().compare("view") == 0) {

        TagViewDialog dlg(this);
        dlg.displayTag(arg1.scheme() + "://" + arg1.path());
    }
}
